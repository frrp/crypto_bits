(ns cryptelo.crypt.e2e
  (:require [cryptelo.crypt.api           :as api]
            [clojure.string               :as str]
            [cryptelo.crypt.bouncy-castle :as bc]
            [cryptelo.host                :as h])
  (:import  [java.security                                     KeyPairGenerator]
            ...
            [cryptelo.crypt.api                                AESKey]
            [cryptelo.crypt.api                                ECSignature]
            [cryptelo.crypt.bouncy_castle                      CipherProcess]
            [cryptelo.crypt.bouncy_castle                      SignProcess]
...
(extend-type cryptelo.crypt.api.ECPublicKey
  cryptelo.crypt.api/ECDeriveSecretPublic
...
(extend-type cryptelo.crypt.api.ECPrivateKey
  cryptelo.crypt.api/ECDeriveSecretPrivate
...
(defrecord ECPublicKeyEncryptor [pub-key ephemereal-key]
  ...
  (-java-init [this]
    (let [aes-key   (AESKey. (derive-key this) nil)
      ...
      (reify cryptelo.crypt.bouncy-castle/ICipher
        (update! [this data]
          (bc/update! aes data))
        (finish! [this data]
...
(extend-type ECPublicKey
  cryptelo.crypt.api/IKeySerialize
